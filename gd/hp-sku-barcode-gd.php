 ...
 *  it will created the barcode from the selected codetype and also add the sku onto the barcodes.
 *
 *   - HP Gong 
 */
...
function hp_barcode_img_s($sku) {
	...
	if ( strtolower($code_type) == "code128a" ) { 	// Code128a 
		...
		$xMax1 = 76;
		$xMin1 = 76;// x Location of imagestring 76
		...
		$xMax1 = 50;
		$xMin1 = 50;// x Location of imagestring 50
		$y1 = 55; // y Location of imagestring
