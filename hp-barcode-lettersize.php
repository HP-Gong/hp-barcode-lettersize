   ...
   public function __construct(){
	  ...
	  add_action('init', array($this, 'check_versions'));
	   ...
	   public static function check_versions(){
	    global $woocommerce;
	    if (version_compare($woocommerce->version, '3.2.6', '<')){
	    $url = admin_url('/plugins.php');
	    require_once(ABSPATH . 'wp-admin/includes/plugin.php');
	    deactivate_plugins( plugin_basename( __FILE__ ));
	    wp_die( __('Barcode Letter-Size is disabled.<br>Barcode Letter-Size requires a minimum of WooCommerce v3.2.6.<br><a href="'.$url.'">Return to the Plugins section</a>'));
	    }
	    }
