 ...
 * */
  ...
  *  This is where the Delete Button was add
  *
  *   - HP Gong 
  */
...
(function ($) {
    ...
    * */
    $.fn.imageUpload = function (options) {
        ...
        $uploadForm.append([$fileInput,$deleteButton, $uploadIframe]);
        ...
        if (!settings.hover) {
            ...
            $controls.addClass("jQuery-image-upload-controls nohover");
